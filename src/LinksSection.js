...
const LinksSection = () =>{
    ...
    return(
        <>
        <a id='twitter_link' href='https://mobile.twitter.com/olowookereisaac'>Twitter Link</a>
        <a id='btn__zuri' href='https://training.zuri.team/'>Zuri Team</a>
        <a id="books" href="http://books.zuri.team">Zuri Books</a>
        <a id="book__python" href="https://books.zuri.team/python-for-beginners?ref_id=<_isaac_>">Python Books</a>
